...
export default function Signup() {
  ...
  return (
    <Container maxWidth="sm" sx={{ mt: 6 }}>
      ...
      <TextField label="Password"   name="password" fullWidth margin="normal" type="password" value={form.password} onChange={handleChange} />
      <TextField label="Confirm"    name="confirm"  fullWidth margin="normal" type="password" value={form.confirm}  onChange={handleChange} />
