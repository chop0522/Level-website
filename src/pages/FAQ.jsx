      ...
      <Container sx={{ mt: 4, mb: 4 }}>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            <Typography variant="body1" paragraph>
              ・貸切プランの料金詳細:
              <br />
              　平日2時間20,000円 / 4時間30,000円
              <br />
              　土日祝日 9:00 - 12:30 30,000円
              <br />
              　※お時間はご相談ください
            </Typography>
          </AccordionDetails>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            <Typography variant="body1" paragraph>
              ・貸切予約の注意点：
              <br />
              　三日前キャンセル料 30% / 二日前 50% / 1日前 80% / 当日 100%
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            <Typography variant="body1" paragraph>
              ・アルコール提供あり / フードメニューはなし。お持ち込みや隣のインドカレー屋さんや Uber
              Eats等をご利用ください。
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography variant="body1" paragraph>
              ・現金、クレジットカード、電子マネー (iD, QUICPayなど)、 PayPayなどのQR決済が利用可。
            </Typography>
            <Typography variant="body1" paragraph>
              ・交通系(ICカード)は利用不可。
            </Typography>
